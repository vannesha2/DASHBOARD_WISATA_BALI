...
# =====================================
st.markdown("<h2 style='font-size: 28px;'>⭐ Distribusi Rating Tempat Wisata</h2>", unsafe_allow_html=True)
st.markdown("<br>", unsafe_allow_html=True)
...
# ----- Box Plot Rating per Kategori -----
with col_rating2:
    fig_rating_box = px.box(
        df_filtered,
        x='kategori',
        y='rating',
        title='📦 Sebaran Rating per Kategori',
        labels={
            'kategori': 'Kategori Wisata',
            'rating': 'Rating'
        },
